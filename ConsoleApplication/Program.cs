...
namespace ConsoleApplication
{
    class Program
    {
        ...
        static void ImportData()
        {
            ...
            model.summa = 1209;
            model.litrs = 30;
            model.payed_at = new DateTime(2016, 8, 5);
            model.SaveOrUpdate();
            model = null;
            ...
            model.summa = 1206;
            model.litrs = 30;
            model.payed_at = new DateTime(2016, 8, 20);
            model.SaveOrUpdate();
            model = null;
            ...
            model.summa = 201;
            model.litrs = 5;
            model.payed_at = new DateTime(2016, 8, 31);
            model.SaveOrUpdate();
            model = null;
            ...
            model.summa = 201;
            model.litrs = 5;
            model.payed_at = new DateTime(2016, 9, 1);
            model.SaveOrUpdate();
            model = null;
            ...
            model.summa = 1540;
            model.litrs = 40;
            model.payed_at = new DateTime(2016, 9, 4);
            model.SaveOrUpdate();
            model = null;
            ...
            model.summa = 1206;
            model.litrs = 30;
            model.payed_at = new DateTime(2016, 9, 11);
            model.SaveOrUpdate();
            model = null;
            ...
            model.summa = 381;
            model.litrs = 10;
            model.payed_at = new DateTime(2016, 9, 20);
            model.SaveOrUpdate();
            model = null;
            ...
            model.summa = 403;
            model.litrs = 10;
            model.payed_at = new DateTime(2016, 9, 24);
            model.SaveOrUpdate();
            model = null;
            ...
            model.summa = 1326;
            model.litrs = 35;
            model.payed_at = new DateTime(2016, 10, 01);
            model.SaveOrUpdate();
            model = null;
            ...
            model.summa = 575;
            model.litrs = 15;
            model.payed_at = new DateTime(2016, 10, 08);
            model.SaveOrUpdate();
            model = null;
